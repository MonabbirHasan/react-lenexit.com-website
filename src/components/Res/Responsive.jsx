            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 col-sm col-lg-6">
                        <div className='py-3'>
                            <div className="title">
                                <p className='title-badge text-white text-uppercase bg-success p-1 d-inline' style={{ fontSize: "10px" }}>Our Design</p>
                                <h3 className='text-capitalize py-2'>Engaging, Adaptive, and User-Friendly Solutions by <span style={{ color: "green" }}>lenextit</span></h3>
                            </div>
                    ...
                    <div className="col-md-6 col-sm col-lg-6">
                        <div className='py-3 res-video'>
                            <video src={responsive_video} autoPlay muted loop security='true' className='img-fluid'></video>
                        </div>
                    </div>
                </div>
            </div>
